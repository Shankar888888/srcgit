...
public class WebelementDisplayedconcept2 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        WebelementDisplayedconcept2.isElementDisplayed(oleme);
        ...
        WebelementDisplayedconcept2.passSendKeys(username, "nucot123456");
        Thread.sleep(3000);
        WebelementDisplayedconcept2.passSendKeys(passWord, "nucot12");
        Thread.sleep(3000);
        By loginButton=By.id("login-button");
        WebelementDisplayedconcept2.doClick(loginButton);
        By errText= By.xpath("//h3[text()='Epic sadface: Username and password do not match any user in this service']");
        String value=WebelementDisplayedconcept2.getValuetext(errText);
